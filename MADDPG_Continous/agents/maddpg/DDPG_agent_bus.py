...
from agents.maddpg.NN_actor_bus import MLPNetworkActor
from agents.maddpg.NN_critic_bus import MLPNetworkCritic
...
class DDPG():
    def __init__(self, obs_dim, act_dim, global_obs_dim, actor_lr, critic_lr, device, action_bound,  chkpt_dir, chkpt_name):
        ...
        self.critic = MLPNetworkCritic(in_dim=obs_dim + act_dim, out_dim=1, hidden_dim = 64, chkpt_dir = chkpt_dir, chkpt_name = (chkpt_name + 'critic.pth')).to(device)
        #优化器

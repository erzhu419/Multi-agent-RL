...
def main_parameters():
    ...
    parser.add_argument('--random_steps', type=int, default=20000, help='random steps before the agent start to learn') #  2e3
    ...
    parser.add_argument('--actor_lr', type=float, default=1e-5, help='learning rate of actor') # .00002
    parser.add_argument('--critic_lr', type=float, default=1e-5, help='learning rate of critic') # .002
    ...
    parser.add_argument('--critic_actor_ratio', type=float, default=5, help='ratio of critic and actor update') # 2.0

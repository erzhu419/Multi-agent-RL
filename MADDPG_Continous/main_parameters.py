...
def main_parameters():
    ...
    parser.add_argument("--episode_num", type = int, default = 20) # 5000
    ...
    parser.add_argument('--random_steps', type=int, default=2000, help='random steps before the agent start to learn') #  2e3
    ...
    parser.add_argument('--batch_size', type=int, default=2048, help='batch-size of replay buffer')  

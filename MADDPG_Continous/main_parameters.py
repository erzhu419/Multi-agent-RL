...
def main_parameters():
    ...
    parser.add_argument("--episode_num", type = int, default = 1) # 5000
    ...
    parser.add_argument('--random_steps', type=int, default=10, help='random steps before the agent start to learn') #  2e3
